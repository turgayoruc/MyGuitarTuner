...
import com.example.myguitartuner.data.audio.AudioTunerEngine
...
class TunerViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val audioEngine = AudioTunerEngine()
    init {observePitch()}
        ...
        when (intent) {
            ...
            is TunerIntent.UpdateHighlighting -> {
                _state.update { currentState ->
                    ...
                    val name = selected.nameEnum

                    when (name) {
                        StringName.STRING1 -> currentState.copy(string1 = currentState.string1.map { it.copy(highlighting = it == selected) })
                        StringName.STRING2 -> currentState.copy(string2 = currentState.string2.map { it.copy(highlighting = it == selected) })
                        StringName.STRING3 -> currentState.copy(string3 = currentState.string3.map { it.copy(highlighting = it == selected) })
                        StringName.STRING4 -> currentState.copy(string4 = currentState.string4.map { it.copy(highlighting = it == selected) })
                        StringName.STRING5 -> currentState.copy(string5 = currentState.string5.map { it.copy(highlighting = it == selected) })
                        StringName.STRING6 -> currentState.copy(string6 = currentState.string6.map { it.copy(highlighting = it == selected) })
                        else -> currentState
                    }
                

//                    currentState.copy(
//                        string1 = currentState.string1.map { it.copy(highlighting = name == StringName.STRING1 && it == selected) },
//                        string2 = currentState.string2.map { it.copy(highlighting = name == StringName.STRING2 && it == selected) },
//                        string3 = currentState.string3.map { it.copy(highlighting = name == StringName.STRING3 && it == selected) },
//                        string4 = currentState.string4.map { it.copy(highlighting = name == StringName.STRING4 && it == selected) },
//                        string5 = currentState.string5.map { it.copy(highlighting = name == StringName.STRING5 && it == selected) },
//                        string6 = currentState.string6.map { it.copy(highlighting = name == StringName.STRING6 && it == selected) },
////                        activeString = when (name) {
////                            StringName.STRING1 -> currentState.string1
////                            StringName.STRING2 -> currentState.string2
////                            StringName.STRING3 -> currentState.string3
////                            StringName.STRING4 -> currentState.string4
////                            StringName.STRING5 -> currentState.string5
////                            StringName.STRING6 -> currentState.string6
////                            else -> currentState.activeString
////                        }
//                          )
                }
            }
...
//                    currentState.copy(
//                            // 1. Tel Kontrolü
//                            string1 = if (selectedItem.nameEnum == StringName.STRING1) {
//                                currentState.string1.map { it.copy(highlighting = it == selectedItem) }
//                            } else {
//                                currentState.string1.map { it.copy(highlighting = false) }
//                            },
//
//                            // 2. Tel Kontrolü
//                            string2 = if (selectedItem.nameEnum == StringName.STRING2) {
//                                currentState.string2.map { it.copy(highlighting = it == selectedItem) }
//                            } else {
//                                currentState.string2.map { it.copy(highlighting = false) }
//                            },
//
//                            // 3. Tel Kontrolü
//                            string3 = if (selectedItem.nameEnum == StringName.STRING3) {
//                                currentState.string3.map { it.copy(highlighting = it == selectedItem) }
//                            } else {
//                                currentState.string3.map { it.copy(highlighting = false) }
//                            },
//
//                            // 4. Tel Kontrolü
//                            string4 = if (selectedItem.nameEnum == StringName.STRING4) {
//                                currentState.string4.map { it.copy(highlighting = it == selectedItem) }
//                            } else {
//                                currentState.string4.map { it.copy(highlighting = false) }
//                            },
//
//                            // 5. Tel Kontrolü
//                            string5 = if (selectedItem.nameEnum == StringName.STRING5) {
//                                currentState.string5.map { it.copy(highlighting = it == selectedItem) }
//                            } else {
//                                currentState.string5.map { it.copy(highlighting = false) }
//                            },
//
//                            // 6. Tel Kontrolü
//                            string6 = if (selectedItem.nameEnum == StringName.STRING6) {
//                                currentState.string6.map { it.copy(highlighting = it == selectedItem) }
//                            } else {
//                                currentState.string6.map { it.copy(highlighting = false) }
//                            },
//
//                            // Hedef frekansı hafızaya alıyoruz (Yeni akort hedefimiz)
//                          //  target = selectedItem.frekans,
//
////                            // Aktif tel listesini de o anki seçime göre güncelliyoruz
////                            activeString = when (selectedItem.nameEnum) {
////                                MyEnumString.STRING1 -> currentState.string1
////                                MyEnumString.STRING2 -> currentState.string2
////                                MyEnumString.STRING3 -> currentState.string3
////                                MyEnumString.STRING4 -> currentState.string4
////                                MyEnumString.STRING5 -> currentState.string5
////                                MyEnumString.STRING6 -> currentState.string6
////                                else -> currentState.activeString
////                            }
//                                     )
//                }
//            }
            ...
            is TunerIntent.UpdateSelectedAllString -> _state.update { currentState ->
                val selectedItem = intent.selectedItem
                when (selectedItem.nameEnum) {
                    StringName.STRING1 -> currentState.copy(selectedBirinci = selectedItem)
                    StringName.STRING2 -> currentState.copy(selectedIkinci = selectedItem)
                    StringName.STRING3 -> currentState.copy(selectedUcuncu = selectedItem)
                    StringName.STRING4 -> currentState.copy(selectedDorduncu = selectedItem)
                    StringName.STRING5 -> currentState.copy(selectedBesinci = selectedItem)
                    StringName.STRING6 -> currentState.copy(selectedAltinci = selectedItem)
